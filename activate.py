...
def activate(dir_ini,web_dir):
    ...
    #filtrar con binry code para dias de agua
        ...
        alerta={}    
        alerta[f]= plot_run(procesado,doy,f,sentinel_dir,web_dir)
    #si alerta True hay ciano, si alerta False esta todo bien y si alerta none es que es alerta naranja y no se sabe bien 
    #alerta naranja puede ser por falta de info debido al filtro de agua
